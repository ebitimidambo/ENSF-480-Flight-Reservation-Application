...
public class PaymentHeader implements Header{
	private User user;
	
	public PaymentHeader(User user){
		this.user = user;
	}
	...
	public JPanel createHeader() {
		...
		JButton goBack = createHeaderButton("x Cancel");
		
		goBack.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e) {
    			Timer goBack = new Timer(20, new ActionListener() {
